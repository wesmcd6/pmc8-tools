...
**Downloads:** get the latest assets from the [`pmc8-dashboard-v0.2.3`](../../releases/tag/pmc8-dashboard-v0.2.3) release.
...
| Windows ZIP | [`PMC8_Dashboard_Windows.zip`](../../releases/download/pmc8-dashboard-v0.2.3/PMC8_Dashboard_Windows.zip) | Extract and run `run_dashboard_windows.bat` |
| macOS ZIP | [`PMC8_Dashboard_macOS.zip`](../../releases/download/pmc8-dashboard-v0.2.3/PMC8_Dashboard_macOS.zip) | Extract, double-click `setup_macos.command` (first run), then `run_PMC8-Dashboard.command` |
| Linux / Raspberry Pi (64-bit) ZIP | [`PMC8_Dashboard_Linux.zip`](../../releases/download/pmc8-dashboard-v0.2.3/PMC8_Dashboard_Linux.zip) | Extract, run `setup_linux.sh` (first run), then `run_dashboard_linux.sh` |
